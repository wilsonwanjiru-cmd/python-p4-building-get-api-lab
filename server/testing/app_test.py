...
class TestApp:
    ...
    def test_bakeries_route(self):
        ...
        response = create_app().test_client().get('/bakeries')
    ...
    def test_bakery_by_id_route(self):
        ...
        with create_app().app_context():
            ...
            response = create_app().test_client().get(f'/bakeries/{b.id}')
            assert response.status_code == 200
            db.session.delete(b)
            db.session.commit()
    ...
    def test_baked_goods_by_price_route(self):
        ...
        response = create_app().test_client().get('/baked_goods/by_price')
        assert response.status_code == 200
    ...
    def test_most_expensive_baked_good_route(self):
        ...
        response = create_app().test_client().get('/baked_goods/most_expensive')
        assert response.status_code == 200
